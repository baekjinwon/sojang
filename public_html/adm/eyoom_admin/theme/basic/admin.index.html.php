...
<?php if ($is_youngcart) { ?>
    ...
    <?php
        $d_sql = "select count(*) as cnt from g5_member where auth = 2 and approval = 1 and DATE_FORMAT(auth_date, '%Y-%m-%d') = CURDATE()";
        $d_row = sql_fetch($d_sql);
        $s_sql = "select count(*) as cnt from g5_shop_item where approve = 1 and DATE_FORMAT(auth_date ,  '%Y-%m-%d') = CURDATE()";
...
<div class="main-headline">
    <h5><strong>처리할 주문</strong><button style="margin-left:10px" class="btn-e btn-e-xs btn-e-brd btn-e-default btn-e-split">기업회원 승인 : <?php echo $d_row['cnt']; ?> 건</button>
<button class="btn-e btn-e-xs btn-e-brd btn-e-default btn-e-split">서식 승인 : <?php echo $s_row['cnt'] ?> 건</button></h5>
    ...
    <div class="col-md-4 md-margin-bottom-30">
        ...
        <div class="site-chart-wrap">
            ...
            <ul class="list-unstyled statistics-list">
                ...
                <li><span>• 신규게시물 :</span><strong><?php echo $visit['newwrite']; ?></strong></li>
            </ul>
        </div>
        <?php /* 사이트 통계 끝 */?>
    </div>
        ...
        <div class="main-headline">
            ...
            <div class="headline-btn btn-group">
                ...
                <ul class="dropdown-menu" role="menu">
                    ...
                    <li><a href="<?php echo G5_ADMIN_URL; ?>/?dir=shopetc&pid=itemsellrank">서식판매 순위</a></li>
                    <li class="divider"></li>
...
<div class="table-wrap">
    <div class="main-headline">
        ...
        <div class="headline-btn btn-group">
                <a href="/shop/ajax.admin1download.php"  type="button" class="btn-e btn-e-xs btn-e-brd btn-e-default btn-e-split">다운로드</a>
    ...
    <div class="table-responsive">
        <table class="table table-bordered table-striped">
            ...
            <tbody>
               <?php 
                    $sql_download ="SELECT 
                    (SELECT COUNT(*) AS '1' FROM g5_download_logs WHERE DATE_FORMAT(create_date,'%Y-%m') = CONCAT(DATE_FORMAT(NOW(),'%Y'),'-01')) AS '1'
                    ,(SELECT COUNT(*) AS '2' FROM g5_download_logs WHERE DATE_FORMAT(create_date,'%Y-%m') = CONCAT(DATE_FORMAT(NOW(),'%Y'),'-02')) AS '2'
                    ,(SELECT COUNT(*) AS '2' FROM g5_download_logs WHERE DATE_FORMAT(create_date,'%Y-%m') = CONCAT(DATE_FORMAT(NOW(),'%Y'),'-03')) AS '3'
                    ,(SELECT COUNT(*) AS '2' FROM g5_download_logs WHERE DATE_FORMAT(create_date,'%Y-%m') = CONCAT(DATE_FORMAT(NOW(),'%Y'),'-04')) AS '4'
                    ,(SELECT COUNT(*) AS '2' FROM g5_download_logs WHERE DATE_FORMAT(create_date,'%Y-%m') = CONCAT(DATE_FORMAT(NOW(),'%Y'),'-05')) AS '5'
                    ,(SELECT COUNT(*) AS '2' FROM g5_download_logs WHERE DATE_FORMAT(create_date,'%Y-%m') = CONCAT(DATE_FORMAT(NOW(),'%Y'),'-06')) AS '6'
                    ,(SELECT COUNT(*) AS '2' FROM g5_download_logs WHERE DATE_FORMAT(create_date,'%Y-%m') = CONCAT(DATE_FORMAT(NOW(),'%Y'),'-07')) AS '7'
                    ,(SELECT COUNT(*) AS '2' FROM g5_download_logs WHERE DATE_FORMAT(create_date,'%Y-%m') = CONCAT(DATE_FORMAT(NOW(),'%Y'),'-08')) AS '8'
                    ,(SELECT COUNT(*) AS '2' FROM g5_download_logs WHERE DATE_FORMAT(create_date,'%Y-%m') = CONCAT(DATE_FORMAT(NOW(),'%Y'),'-09')) AS '9'
                    ,(SELECT COUNT(*) AS '2' FROM g5_download_logs WHERE DATE_FORMAT(create_date,'%Y-%m') = CONCAT(DATE_FORMAT(NOW(),'%Y'),'-10')) AS '10'
                    ,(SELECT COUNT(*) AS '2' FROM g5_download_logs WHERE DATE_FORMAT(create_date,'%Y-%m') = CONCAT(DATE_FORMAT(NOW(),'%Y'),'-11')) AS '11'
                    ,(SELECT COUNT(*) AS '2' FROM g5_download_logs WHERE DATE_FORMAT(create_date,'%Y-%m') = CONCAT(DATE_FORMAT(NOW(),'%Y'),'-12')) AS '12'
                    FROM dual";
                    $result_download = sql_fetch($sql_download);

                    $sql_fail ="select
                    (SELECT COUNT(*) FROM g5_shop_cart WHERE ct_status = '완료' AND it_id not in('1659019167','1672642574','1672642610','1672642648') AND DATE_FORMAT(ct_time,'%Y-%m') = CONCAT(DATE_FORMAT(NOW(),'%Y'),'-01')) AS '1'
                    ,(SELECT COUNT(*) FROM g5_shop_cart WHERE ct_status = '완료' AND it_id not in('1659019167','1672642574','1672642610','1672642648') AND DATE_FORMAT(ct_time,'%Y-%m') = CONCAT(DATE_FORMAT(NOW(),'%Y'),'-02')) AS '2'
                    ,(SELECT COUNT(*) FROM g5_shop_cart WHERE ct_status = '완료' AND it_id not in('1659019167','1672642574','1672642610','1672642648') AND DATE_FORMAT(ct_time,'%Y-%m') = CONCAT(DATE_FORMAT(NOW(),'%Y'),'-03')) AS '3'
                    ,(SELECT COUNT(*) FROM g5_shop_cart WHERE ct_status = '완료' AND it_id not in('1659019167','1672642574','1672642610','1672642648') AND DATE_FORMAT(ct_time,'%Y-%m') = CONCAT(DATE_FORMAT(NOW(),'%Y'),'-04')) AS '4'
                    ,(SELECT COUNT(*) FROM g5_shop_cart WHERE ct_status = '완료' AND it_id not in('1659019167','1672642574','1672642610','1672642648') AND DATE_FORMAT(ct_time,'%Y-%m') = CONCAT(DATE_FORMAT(NOW(),'%Y'),'-05')) AS '5'
                    ,(SELECT COUNT(*) FROM g5_shop_cart WHERE ct_status = '완료' AND it_id not in('1659019167','1672642574','1672642610','1672642648') AND DATE_FORMAT(ct_time,'%Y-%m') = CONCAT(DATE_FORMAT(NOW(),'%Y'),'-06')) AS '6'
                    ,(SELECT COUNT(*) FROM g5_shop_cart WHERE ct_status = '완료' AND it_id not in('1659019167','1672642574','1672642610','1672642648') AND DATE_FORMAT(ct_time,'%Y-%m') = CONCAT(DATE_FORMAT(NOW(),'%Y'),'-07')) AS '7'
                    ,(SELECT COUNT(*) FROM g5_shop_cart WHERE ct_status = '완료' AND it_id not in('1659019167','1672642574','1672642610','1672642648') AND DATE_FORMAT(ct_time,'%Y-%m') = CONCAT(DATE_FORMAT(NOW(),'%Y'),'-08')) AS '8'
                    ,(SELECT COUNT(*) FROM g5_shop_cart WHERE ct_status = '완료' AND it_id not in('1659019167','1672642574','1672642610','1672642648') AND DATE_FORMAT(ct_time,'%Y-%m') = CONCAT(DATE_FORMAT(NOW(),'%Y'),'-09')) AS '9'
                    ,(SELECT COUNT(*) FROM g5_shop_cart WHERE ct_status = '완료' AND it_id not in('1659019167','1672642574','1672642610','1672642648') AND DATE_FORMAT(ct_time,'%Y-%m') = CONCAT(DATE_FORMAT(NOW(),'%Y'),'-10')) AS '10'
                    ,(SELECT COUNT(*) FROM g5_shop_cart WHERE ct_status = '완료' AND it_id not in('1659019167','1672642574','1672642610','1672642648') AND DATE_FORMAT(ct_time,'%Y-%m') = CONCAT(DATE_FORMAT(NOW(),'%Y'),'-11')) AS '11'
                    ,(SELECT COUNT(*) FROM g5_shop_cart WHERE ct_status = '완료' AND it_id not in('1659019167','1672642574','1672642610','1672642648') AND DATE_FORMAT(ct_time,'%Y-%m') = CONCAT(DATE_FORMAT(NOW(),'%Y'),'-12')) AS '12'
                    FROM dual;";
...
<div class="chart-wrap">
    <div class="chart-item item-left">
        ...
        <div class="main-headline">
            ...
            <div class="headline-btn btn-group">
                <a href="/shop/ajax.admin2download.php" style="margin-right:17px" type="button" class="btn-e btn-e-xs btn-e-brd btn-e-default btn-e-split">다운로드</a>
                
            </div>
            <div class="clearfix"></div>
        </div>
        <div class="table-list-eb main-table" style="height:144px;overflow:auto">
            <div class="table-responsive">
                    <table class="table table-bordered table-striped">
                    <thead>
                        <tr>
    ...
    <div class="chart-item item-right">
        ...
        <div class="main-headline">
            ...
            <div class="headline-btn btn-group">
            <a href="/shop/ajax.admin3download.php" style="margin-right:17px" type="button" class="btn-e btn-e-xs btn-e-brd btn-e-default btn-e-split">다운로드</a>
        ...
        <div class="table-list-eb main-table" style="height:144px;overflow:auto" >
            ...
            <table class="table table-bordered table-striped">
                    ...
                    <?php 
                            ...
                            ,a.it_name
                            ,a.create_id
                            ,(SELECT mb_name FROM g5_member WHERE mb_id = a.create_id) AS mb_name
                            FROM g5_shop_cart d
                            LEFT JOIN g5_shop_item a
                            ON d.it_id = a.it_id
                            WHERE d.ct_status = '완료' 
                            AND a.it_id not in('1659019167','1672642574','1672642610','1672642648')
                            AND DATE_FORMAT(d.ct_time,'%Y-%m-%d') = DATE_FORMAT(NOW(),'%Y-%m-%d')
                            ...
                            WHERE d.ct_status = '완료' 
                            AND a.it_id not in('1659019167','1672642574','1672642610','1672642648')
                            AND DATE_FORMAT(d.ct_time,'%Y-%m') = DATE_FORMAT(NOW(),'%Y-%m')
                            group BY a.create_id
                            ";
                            $result_order_month = sql_query($sql_order_month);
