        ...
        <div class="col col-9">
            <div class="margin-bottom-5">
                <span class="font-size-12 color-grey">
                    <a href="<?php echo G5_ADMIN_URL; ?>/?dir=<?php echo $dir; ?>&amp;pid=<?php echo $pid; ?>">[전체목록]</a><span class="margin-left-10 margin-right-10 color-light-grey">|</span>등록된 서식 <?php echo number_format($total_count); ?>건
                </span>
            </div>
        </div>
        <div class="col col-3">
...
!function () {
    ...
    db.clients   = [
        ...
        {
            넘버: "<?php echo $list[$i]['wr_id']?>",
            
            대량등록파일: "<?php echo "<a href='../data/exceldoc/".$list[$i]['bf_file']."' download='".$list[$i]['bf_source']."'>".$list[$i]['bf_source']."</a>";?>",
            등록인: "<?php echo $list[$i]['mb_id'];?>",
            
            등록일: "<?php echo date("Y-m-d", strtotime($list[$i]['bf_datetime'])); ?>",
        },
        <?php } ?>
    ]
}();
...
$(document).ready(function(){
    $("#admin-shop-itemlist").jsGrid({
        ...
        height         : "auto",
        fields         : [
            { name: "넘버", type: "text", width: 30 },            
            { name: "대량등록파일", type: "text", width: 80 },
            { name: "등록인", type: "text", align: "center",width: 80 },
