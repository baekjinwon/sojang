    ...
    <div class="adm-table-form-wrap margin-bottom-30">
        ...
        <fieldset>
            <div class="text-center margin-top-10 margin-bottom-10">
                <a href="<?php echo G5_URL; ?>/<?php echo G5_LIB_DIR; ?>/Excel/itemexcel_eyoom.xls?ver=2" class="btn btn-e-md btn-e-dark"><i class="fas fa-file-alt"></i> 서식일괄등록용 엑셀파일 다운로드</a>
            </div>
        </fieldset>
