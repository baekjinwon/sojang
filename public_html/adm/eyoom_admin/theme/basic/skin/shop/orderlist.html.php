...
<div class="admin-shop-orderlist">
                                ...
                                <div class="margin-bottom-5">
                                    <label class="select form-width-150px">
                                        <select name="sel_field" id="sel_field">
                                            ...
                                            <option value="it_name" <?php echo get_selected($sel_field, 'it_name'); ?>>서식명</option>
    ...
    <p>
        <input type="checkbox" name="od_status" value="<?php echo $change_status; ?>"> <?php echo $od_status; ?> 상태에서 <strong><?php echo $change_status; ?>(완료)</strong> 상태로 변경합니다.
...
$(document).ready(function(){
    $("#order-list").jsGrid({
        ...
        fields         : [
            ...
            { name: "주문번호_서식명_상태", type: "text", width: 250 },
