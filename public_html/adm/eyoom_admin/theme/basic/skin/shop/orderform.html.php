...
<div class="admin-shop-orderform">
	...
	<div id="anc_sodr_list">
        ...
        <div class="table-list-eb">
            <div class="table-responsive">
                <table class="table table-bordered">
                    <thead>
                        <tr>
                            <th class="width-100px">서식이미지</th>
                            <th class="width-200px">주문번호 / 서식명</th>
                            <th>
        ...
        <div class="alert alert-warning">
            <p>주문, 입금, 준비, 완료는 장바구니와 주문서 상태를 모두 변경하지만, 취소, 반품, 품절은 장바구니의 상태만 변경하며, 주문서 상태는 변경하지 않습니다.<br>개별적인(이곳에서의) 상태 변경은 모든 작업을 수동으로 처리합니다. 예를 들어 주문에서 입금으로 상태 변경시 입금액(결제금액)을 포함한 모든 정보는 수동 입력으로 처리하셔야 합니다.</p>
        </div>
    ...
    <div id="anc_sodr_chk">
				...
				<div class="col col-6">
					...
					<div class="row">
						...
						<div class="col col-8">
							...
							<div class="note margin-bottom-10"><strong>Note:</strong> 주문자님께 입금내역을 메일로 발송합니다. 메일발송시 상점메모에 기록됩니다.</div>
						</div>
					</div>
					<?php } ?>
				</div>
		...
		<div class="text-center margin-top-30 margin-bottom-30">
			<input type="submit" value="결제내역 수정" class="btn-e btn-e-lg btn-e-red" accesskey="s">
	...
	<div id="anc_sodr_orderer"><div id="anc_sodr_taker"></div>
		...
		<div class="text-center margin-top-30 margin-bottom-30">
			<input type="submit" value="주문자 정보 수정" class="btn-e btn-e-lg btn-e-red">
			<a href="<?php echo G5_ADMIN_URL; ?>/?dir=shop&amp;pid=orderlist&amp;qstr=<?php echo $qstr; ?>" class="btn-e btn-e-lg btn-e-dark">목록보기</a>
		</div>
	    </form>
    </div>
