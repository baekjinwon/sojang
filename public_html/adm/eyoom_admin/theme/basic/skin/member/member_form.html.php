        ...
        <div class="table-list-eb">
            ...
            <table class="table">
                <tbody>
                    ...
                    <tr>
                        <th class="table-form-th">
                            <label for="mb_icon" class="label">증빙자료</label>
                        </th>
                        <td>
                            <?php if($mb['au_zip_file_url']) {?>
                            <a href="<?php echo G5_URL.'/data/member/'.$mb['au_zip_file_url']; ?>" class="btn-e btn-e-lg btn-e-dark" download>증빙자료 다운로드</a>
                            <?php }?>
                        </td>
