...
$sql = " select od_id,
            ...
            (SELECT COUNT(*) FROM g5_download_logs where od_id = 'prime' and SUBSTRING(create_date , 1,10)  =  SUBSTRING(od_time,1,10)) AS primecnt,
            (SELECT COUNT(*) FROM g5_download_logs where od_id != 'prime' and SUBSTRING(create_date , 1,10)  =  SUBSTRING(od_time,1,10)) AS normalcnt
