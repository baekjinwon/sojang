<?php
/**
 * @file    /adm/eyoom_admin/core/shopetc/sale1month.php
 */
...
// , aa.it_id
// , bb.create_id 
// ,(SELECT SUM(po_point) FROM g5_point where mb_id = bb.create_id and SUBSTRING(po_datetime , 1,7) = aa.od_date AND po_rel_table = '@download') AS po_point
// , (SELECT COUNT(*) FROM g5_download_logs dd where dd.od_id = 'prime' and SUBSTRING(dd.create_date , 1,7) = aa.od_date AND dd.create_id = bb.create_id) AS primecnt
// , (SELECT COUNT(*) FROM g5_download_logs dd where dd.od_id != 'prime' and SUBSTRING(dd.create_date , 1,7) = aa.od_date  AND dd.create_id = bb.create_id) AS normalcnt
// FROM (
// SELECT a.od_id,
...
$sql .= " where SUBSTRING(od_time , 1, 7) BETWEEN '$fr_month' AND '$to_month' ";
