...
if ($eyoom['is_responsive'] == '1' || G5_IS_MOBILE) { // 반응형 또는 모바일일때
    add_stylesheet('<link rel="stylesheet" href="'.EYOOM_THEME_URL.'/css/style.css?ver='.G5_CSS_VER.'" type="text/css" media="screen">',0);
} else if ($eyoom['is_responsive'] == '0' && !G5_IS_MOBILE) { // 비반응형이면서 PC버전일때
    add_stylesheet('<link rel="stylesheet" href="'.EYOOM_THEME_URL.'/css/style-nr.css?ver='.G5_CSS_VER.'" type="text/css" media="screen">',0);
}
...
<style>
    ...
    <?php } ?>
        ...
        <div class="header-topbar">
            <div class="container clear-after" style="padding: 0 !important">
                <div class="topbar-left hidden-xs">
                    <?php echo eb_latest('1563521950'); ?>
                </div>

                <ul class="topbar-right list-unstyled" style="padding: 0 !important">
 ...
 <!--//1659019167 -->
                     ...
                     <?php    }
                        ...
                        <li><a href="<?php echo correct_goto_url(G5_ADMIN_URL); ?>" style="color: red;">서식등록 관리</a></li><!--박찬영 수정 -->
                    <?php } ?>
...
<!-- 박찬영 수정 스타일-->
<style>
.dropdown-menu>li>a{white-space: wrap !important;}
</style>