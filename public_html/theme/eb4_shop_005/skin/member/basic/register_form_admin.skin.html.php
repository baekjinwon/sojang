...
<div class="register-form">
    <form id="fregisterform" name="fregisterform" action="<?php echo G5_URL; ?>/bbs/register_form_admin_update.php" onsubmit="return fregisterform_submit(this);" method="post" enctype="multipart/form-data" autocomplete="off" class="eyoom-form">
    ...
    <div class="register-box">
        <header><h5 class="margin-0"><strong>회원정보 입력</strong></h5></header>
        <fieldset>
            <div class="row">
        ...
        <header class="border-top"><h5 class="margin-0"><strong>회원정보 입력</strong></h5></header><!--박찬영수정-->
        <fieldset>
            <div class="row">
            ...
            <div class="row">
                <div class="col col-5">
                    <label for="reg_mb_bank_account" class="label width-100 position-relative">
                        증빙자료<strong class="sound_only">필수</strong>
                    </label>
                    <label class="input input-button required-mark">
                    <label class="input input-file">
                                            <div class="button" style="color:white"><input type="file" name="mb_zip_file" id="mb_zip_file" onchange="this.parentNode.nextSibling.value = this.value">압축파일 업로드</div><input type="text" readonly="">
                                        </label>
                    </label>
                ...
                <div class="col col-12">
                    <div class="alert alert-warning padding-all-10 margin-top-10">
                        <strong>Note:</strong> 정산을 위해 사업자등록증 or신분증 사본(주민등록번호 뒷 7자리 가림처리), 통장사본 등을 압축파일로 첨부하여 보내주시길 바랍니다.<!--박찬영 수정 -->
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col col-12">
                    <div class="alert alert-warning padding-all-10 margin-top-10">
                        <strong>Note:</strong> 인증 및 정산을 위해 핸드폰번호를 꼭 기재해 주시길 바랍니다. 
                    </div>
                </div>
            </div>
