...
.shop-order-form .order-payment-area {top:0;right:0;width:100%;height:100%;border-left:1px solid #e5e5e5;background:#fafafa;padding:15px;box-sizing:border-box}
...
@media (max-width:991px) {
    .shop-order-form .order-member-area {margin-right:0 ;height:783px;}
