...
.shop-order-form .sod-li-wrap .li-op-img img {display:block;width:100% \9;max-width:100%;height:auto}
.shop-order-form .sod-li-wrap .sod-opt {font-size:12px;color:#959595}
.shop-order-form .sod-li-wrap .cp_btn {padding:3px 15px;height:inherit;line-height:1}
.shop-order-form .sod-li-wrap .cp_cancel {display:inline-block;margin:0 0 0 3px;font-weight:normal;text-align:center;background:#fff;border:1px solid #d5d5d5;padding:3px 15px;color:#757575;font-size:12px;line-height:1;height:inherit}
.shop-order-form .sod-li-wrap .li-prqty {margin:10px;border-top:1px solid #e5e5e5;padding:10px 0 0}
.shop-order-form .sod-li-wrap .li-prqty:after {display:block;visibility:hidden;clear:both;content:''}
.shop-order-form .sod-li-wrap .li-prqty-sp {float:left;width:50%;display:block;line-height:20px;padding:0 7px;margin-bottom:5px;text-align:right;box-sizing:border-box}
...
.shop-order-form .sod-li-wrap .total_price {background:#f5f5f5;border:1px solid #d5d5d5;display:block;clear:both;margin:10px;text-align:right;padding:7px 10px;line-height:20px}
.shop-order-form .sod-li-wrap .total_price span {float:left;font-weight:bold;font-size:13px}
.shop-order-form .sod-li-wrap .total_price strong {font-size:14px;color:#FF4848}
.shop-order-form .sod-li-wrap .sod-opt li {padding:0;color:#757575;margin:3px 0;line-height:1.5}
.shop-order-form .order-payment-total {border:1px solid #FF7070;margin-bottom:20px}
...
.shop-order-form .payment-point-box {position:relative;overflow:hidden;clear:both;padding:10px 15px;border-bottom:1px solid #e5e5e5;border-top:0;background:#fff;text-align:right;font-size:13px;color:#757575}
.shop-order-form .payment-point-box span {float:left}
.shop-order-form .payment-point-box strong {color:#000}
.shop-order-form .payment-total-box {position:relative;overflow:hidden;clear:both;padding:10px 15px;background:#fff;text-align:right;font-size:13px;color:#757575}
.shop-order-form .payment-total-box span {float:left}
.shop-order-form .payment-total-box strong {color:#FF4848;font-size:16px}
...
.shop-order-form .payment-info-box .cp_cancel1 {display:inline-block;margin:0 0 0 3px;font-weight:normal;text-align:center;background:#fff;border:1px solid #d5d5d5;padding:4px 12px;color:#757575;font-size:12px;line-height:1;height:inherit}
...
.shop-order-form #od_tot_price .print_price {color:#FF4848;font-size:16px}
...
.shop-order-form .btn_confirm a.btn_cancel {display:block;width:100%;height:40px;line-height:40px;padding:0;background:#fff;color:#757575;font-size:14px;font-weight:bold;letter-spacing:0;border:1px solid #d5d5d5;box-sizing:border-box}
...
.shop-order-form #settle_bank label {float:inherit;line-height:inherit;text-align:inherit}
...
<div class="shop-order-form">
    ...
    <div class="order-member-area">
        <?php /* ---------- 주문하시는 분 입력 시작 ---------- */ ?>
        <div class="sod-frm-orderer" style="display:none">
        ...
        <?php /* ---------- 받으시는 분 입력 시작 ---------- */ ?>
        <div class="sod-frm-taker" style="display:none">
    ...
    <div class="order-payment-info">
        ...
        <div class="payment-info-box">
            ...
            <button type="button" id="od_coupon_btn" class="btn-e btn-e-dark" data-toggle="modal" data-target="#modal_od_coupon_apply">쿠폰적용</button>
        </div>
        <div class="payment-info-box">
            <span>주문할인금액</span>
