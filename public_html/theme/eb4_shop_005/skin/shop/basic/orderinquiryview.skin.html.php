                ...
                <table class="table">
                    <thead>
                        <tr>
                            ...
                            <th scope="col" colspan="7" id="th_itname" class="text-left">서식명</th>
                        </tr>
                        <tr>
                    ...
                    <tbody>
                        ...
                        <?php } ?>
                        <?php 
                        $ct_item_sql = "select ct_history , it_id from g5_shop_cart where od_id = '{$od_id}' limit 1";
                        ...
                        <tr>
                            ...
                            <?php if($opt['ct_status'] == "완료" && 4 > $days) { ?>
                                <td headers="th_itst" class="td-bg-color text-center">
                                <?php if($order[$i]['it_file_1']) { ?>
                                    <a style="color:white" onclick="downloadCount('<?php echo $order[$i]['it_id'] ?>','<?php echo $od_id ?>')" class="btn-e btn-e-lg btn-e-dark" href="<?php echo G5_URL."/data/item/".$order[$i]['it_id']."/".$order[$i]['it_file_1']; ?>" download><img src="/img/hwp.png" style="width:50px" /> </a>
                                <?php } ?>
                                <?php if($order[$i]['it_file_2']) { ?>
                                    <a style="color:white" onclick="downloadCount('<?php echo $order[$i]['it_id'] ?>','<?php echo $od_id ?>')" class="btn-e btn-e-lg btn-e-dark" href="<?php echo G5_URL."/data/item/".$order[$i]['it_id']."/".$order[$i]['it_file_2']; ?>" download><img src="/img/wd.png" style="width:50px" /> </a>
                                <?php } ?>
                                <?php if($order[$i]['it_file_3']) { ?>
                                    <a style="color:white" onclick="downloadCount('<?php echo $order[$i]['it_id'] ?>','<?php echo $od_id ?>')" class="btn-e btn-e-lg btn-e-dark" href="<?php echo G5_URL."/data/item/".$order[$i]['it_id']."/".$order[$i]['it_file_3']; ?>" download><img src="/img/pp.png" style="width:50px" /> </a>
                                <?php } ?>
                                </td>
<!--                            
                                <td headers="th_itst" class="td-bg-color text-center"><a style="color:white" class="btn-e btn-e-lg btn-e-dark" href="<?php echo G5_URL."/data/item/".$order[$i]['it_id']."/".$order[$i]['it_file_1']; ?>" download>다운로드</a></span></td>
                                -->
                                <?php }else{ ?>
                                    ...
                                    <?php }else { ?>
                                        <?php if($opt['ct_status'] == "완료") { ?>
                                            <td headers="th_itst" class="td-bg-color text-center"><strong class="color-red">기간초과</span></td>
                                        <?php }else{ ?>
                                            <td headers="th_itst" class="td-bg-color text-center"><strong class="color-red"><?php echo $opt['ct_status']; ?></span></td>
                                        <?php } ?>        
                                    <?php } ?>
        ...
        <script>
        function downloadCount(it_id , v_od_id){
            $.ajax({
            type: 'POST',
            data: {
                it_id : it_id
    ...
    <div class="order-view-payment">
        <div class="order-view-member-area">
            <div class="order-view-member-box" style="height:524px">
                <div class="headline-short"><h5><strong>결제 정보</strong></h5></div>
                <div class="table-list-eb">
                    <table class="table">
                        <tbody>
                            <tr>
            ...
            <div class="order-view-member-box" style="display:none">
            ...
            <div class="order-view-member-box border-bottom-0"  style="display:none">
        ...
        <div class="order-view-payment-area" style="height:524px">
