...
for ($i=0; $row=sql_fetch_array($result); $i++) {
    ...
    <div class="col-md-6 md-margin-bottom-30">
        ...
        <div class="main-headline">
            ...
            <div class="headline-btn" style="float:right">
                <a style="display:none" href="<?php echo G5_ADMIN_URL; ?>/?dir=shop&pid=itemqalist" class="btn-e btn-e-xs btn-e-brd btn-e-default">전체보기 <i class="fas fa-plus"></i></a>
            </div>
    ...
    <div class="col-md-6">
        ...
        <div class="main-headline">
            ...
            <div class="headline-btn" style="float:right">
                <a style="display:none" href="<?php echo G5_ADMIN_URL; ?>/?dir=shop&pid=itemuselist" class="btn-e btn-e-xs btn-e-brd btn-e-default">전체보기 <i class="fas fa-plus"></i></a>
            </div>
            <div class="clearfix"></div>
        </div>
