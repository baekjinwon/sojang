        ...
        <div class="col-sm-6">
            ...
            <div class="shop-product-form 2017_renewal_itemform">
                ...
                <div class="shop-description-box">
                    <table class="table">
                        <tbody>
                        <?php if($start_date_dl > $current_date_dl || $end_date_dl < $current_date_dl || $is_member == false){ ?>
                            ...
                            */
                            ?>
                            <?php if($start_date_dl > $current_date_dl || $end_date_dl < $current_date_dl || $is_member == false){ ?>
                            <?php if ($config['cf_use_point'] && (($it['it_id'] != '1659019167' && $it['it_id'] != '1672642574' && $it['it_id'] != "1672642610" && $it['it_id'] != "1672642648"  ))) { // 포인트 사용한다면 ?>
                            <tr>
                                <th scope="row">포인트</th>
                                <td>
                                    <?php
                                    if($it['it_point_type'] == 2) {
                                        echo '구매금액의 '.$it['it_point'].'%';
                                    } else {
                ...
                <script>
                    function downloadCount(it_id , od_id){
                        $.ajax({
                        type: 'POST',
                        data: {
                            it_id : it_id
