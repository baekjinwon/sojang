...
.basic-body-main>p{display: none;}
/* Tag */
...
<div class="board-write">
    ...
    <section class="margin-top-20">
        <div class="row">
            <?php if ($is_name) { ?>
            <div class="col col-3">
                <label for="wr_name" class="label">이름<span style="color: red;">*</span><strong class="sound_only">필수</strong></label><!--writecopy.skin.html 박찬영 수정 -->
            ...
            <div class="col col-3">
                <label for="wr_password" class="label">비밀번호<span style="color: red;">*</span><strong class="sound_only">필수</strong></label><!--writecopy.skin.html 박찬영 수정 -->
                <label class="input required-mark margin-bottom-10">
    ...
    <div class="margin-hr-10"></div>
    <section>
        <div class="row" style="margin-left:0px;margin-right:17px">
           
            <script>
                    function selectChangeEvent(){
                        if($("#selectpp option:selected").val() == "1"){
                            
                            $("#wr_content").val($("#selectpp option:selected").text())
                            $("#wr_content").attr("readonly","readonly");
                        }else{
                            $("#wr_content").val("");
    ...
    <section>
        ...
        <div class="row">
            <div class="col col-12">
                <label class="label">침해자료 URL <?php echo $i; ?></label>
                <label class="input">
    ...
    <p style="color: red;margin-bottom: 10px">*표는 필수입력해주세요.</p><!--writecopy.skin.html 박찬영 수정 -->
    <?php } ?>
...
<?php if ($config['cf_map_google_id']) { ?>
<script src="https://maps.googleapis.com/maps/api/js?key=<?php echo $config['cf_map_google_id']; ?>" defer></script>
<?php } ?>
<?php if ($config['cf_map_naver_id']) { ?>
